...
| 계획 수립과 자기수정 | 12 | plan-and-execute, reflection(generate→critique→revise), 반응형과 대비 | 계획·자기수정 에이전트 |
...
| 평가·검증·관찰 | 21 | LLM-as-judge, 트레이싱, 테스트셋·품질·개선 로그·한계 분석 | 평가 하네스 |
