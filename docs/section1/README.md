...
| [lec06](lec06/README.md) | 5 | LiteLLM 멀티 프로바이더 | 멀티 프로바이더 래퍼 |
| [lec07](lec07/README.md) | 5 | Ollama 로컬 | 로컬 호출 예제 |
| [lec08](lec08/README.md) | 22 | 구조화 출력 1 | Pydantic 모델 |
| [lec09](lec09/README.md) | 21 | 구조화 출력 2 | 안전한 추출 함수 |
