...
| 단위 | 분 | 주제 | 산출물 |
| --- | --- | --- | --- |
| [lec01](lec01/README.md) | 10 | FastAPI 서빙 + 스트리밍 | 추론 API 서버 |
| [lec02](lec02/README.md) | 27 | 통합 웹 서비스 (채팅 + 관리자) | 통합 데모 레포 |

합계 37분, 2단위입니다. lec02는 end-to-end 통합 데모를 겸해, 별도 캡스톤을 두지 않습니다.
