...
| 체크포인트 | 한 작업이 중단되면 그 자리부터 재개 | LangGraph (lec05·06) |
...
"끝난 스텝은 건너뛰고 죽은 자리부터 잇기"가 바로 LangGraph가 노드마다 자동으로 하는 일입니다. lec05·06에서 다룹니다. 체크포인트 입자가 고울수록 정확히 재개하지만 코드가 복잡해집니다.
